    ...
    return (
      <div className="navbar-main">
        ...
        <div className="conn-insc-btn">
          <Link to="/connection">
            <span className="conn-btn">Connection</span>
          </Link>
          <input className="insc-btn" type="button" value="Inscription" />
        </div>
      </div>
    );
  }
